...
public class ShaclPart3 {
	...
	public static void main(String[] args) throws RDFParseException, RepositoryException, IOException {
        ...
        try (SailRepositoryConnection connection = sailRepository.getConnection()) {
                ...
                StringReader shaclPart3 = new StringReader(
                        String.join("\n", "",
                ...
                StringReader shaclRules3 = new StringReader(
                        String.join("\n", "",
                ...
                connection.add(shaclPart3, "", RDFFormat.TURTLE, RDF4J.SHACL_SHAPE_GRAPH);
               ...
               // InputStream file_ttl=new FileInputStream("A.ttl");
